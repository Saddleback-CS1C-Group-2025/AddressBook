...
// CONSTANTS
//=================================================================
const std:: string AddressBookSF:: DEFAULT_FILENAME = "addressbook.csv";

//=================================================================
// CONSTRUCTOR
//=================================================================
AddressBookSF::AddressBookSF()
{
...
// used for modifying
std:: vector<Contact>:: iterator AddressBookSF:: findContactById(int id)
{
    /******************************************************************
...
// used for reading 
std:: vector<Contact>:: const_iterator AddressBookSF:: findContactById(int id) const
{
    /******************************************************************
    * SUMMARY - Locates contact by unique ID for modification operations
    * PARAM - id The unique identifier of contant to find
...
bool AddressBookSF:: containsCaseInsensitive(const std:: string& str, const std:: string& substr)
{
    /******************************************************************
...
std:: vector<Contact> AddressBookSF::SearchByName(const std:: string &nameQuery) const
{
    /******************************************************************
...
std:: vector<Contact> AddressBookSF::SearchByEmail(const std:: string &emailQuery) const
{
    /******************************************************************
...
std:: vector<Contact> AddressBookSF::SearchByPhone(const std:: string &phoneQuery) const
{
    /******************************************************************
...
std:: vector<Contact> AddressBookSF:: FilterByType(const std::string& type) const
{
    /******************************************************************
...
std:: vector<Contact> AddressBookSF:: FilterByCity(const std::string& city) const
{
    /******************************************************************
...
std:: vector<Contact> AddressBookSF:: FilterByTag(const std::string& tag) const
{
    /******************************************************************
...
void AddressBookSF:: DisplaySearchResults(const std::vector<Contact>& results, const std::string& searchType) const
{
    /******************************************************************
