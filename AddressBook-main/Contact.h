...
public:
    ...
    // For importing from file: set the id read from disk and advance
    // the global nextId_ if necessary so newly created contacts do
    // not collide with imported ids.
    void setIdForImport(int importedId);
